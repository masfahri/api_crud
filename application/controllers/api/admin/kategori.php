...
class Kategori extends REST_Controller {
      ...
      if ($this->is_logged_in() != null){
         if($this->form_validation->run('create_kategori') == FALSE) {
            ...
            if ($image_path == null) {
               ...
               $upload = $this->_doUpload($image_path, $nama_kategori, 'produk/GambarKategori');
            }
            $insertData = array(
   ...
   public function updateGambar_post()
   {
    ...
    public function _usernameRegex($userName) {
      if (preg_match('/^[a-z0-9]+$/', $userName )) { return TRUE; } else { return FALSE;}
    }
